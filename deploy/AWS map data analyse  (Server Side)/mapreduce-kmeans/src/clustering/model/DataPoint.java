 ...
 *
 */
public final class DataPoint implements WritableComparable<DataPoint>, Writable {

	private DoubleVector vector = new DenseDoubleVector(new double[] {});
...
//		if (v.getVector() != null)
	...
	public DataPoint(DoubleVector v) {
		if (v != null)
			this.vector = v;
	}
	...
	public void add(Iterable<DataPoint> dataPoint) {
